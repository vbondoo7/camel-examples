...
public class CCCOATranslationNewToOldLookupAssembler {
	...
	public CCCOATranslationNewToOldLookupResponseType assembler(
			@Body CCCOATranslationNewToOldLookupRequestType request) {
		...
		response.setEntity(request.getLegalEntity()); // response.setInterCompany();
